        ...
        <div className="mt-auto border-t border-slate-800 pt-4 flex-shrink-0">
          <div className="relative">
            <button
              ...
              className="group flex w-full items-center gap-3 rounded-lg border border-slate-800 bg-slate-900/60 p-3 text-left transition-all hover:border-emerald-500/30 hover:bg-slate-800/60"
            >
              {/* Avatar */}
              <div className="relative">
                {user?.avatar ? (
                  ...
                  <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-emerald-500/30 bg-gradient-to-br from-emerald-500/20 to-cyan-500/20 text-sm font-bold text-emerald-400">

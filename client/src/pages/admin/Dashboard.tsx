            ...
            {activePanel === "dashboard" ? (
              <section className="space-y-6">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                  {/* Cities Card */}
                  <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-blue-500/10 via-slate-900/80 to-slate-950/90 p-6 backdrop-blur-xl transition-all hover:border-blue-400/30 hover:shadow-lg hover:shadow-blue-500/20">
                  ...
                  {/* Locations Card */}
                  <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-emerald-500/10 via-slate-900/80 to-slate-950/90 p-6 backdrop-blur-xl transition-all hover:border-emerald-400/30 hover:shadow-lg hover:shadow-emerald-500/20">
                  ...
                  {/* Roads Card */}
                  <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-purple-500/10 via-slate-900/80 to-slate-950/90 p-6 backdrop-blur-xl transition-all hover:border-purple-400/30 hover:shadow-lg hover:shadow-purple-500/20">
                    ...
                    <div className="relative space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-slate-400">Road segments</p>
                      </div>
                    </div>
                  </div>

                  {/* Users Card */}
                  <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-cyan-500/10 via-slate-900/80 to-slate-950/90 p-6 backdrop-blur-xl transition-all hover:border-cyan-400/30 hover:shadow-lg hover:shadow-cyan-500/20">
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900/90 via-slate-900/80 to-slate-950/90 backdrop-blur-xl p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between rounded-lg border border-white/5 bg-slate-950/30 p-3">
                    ...
                    {Object.entries(LOCATION_CATEGORIES).map(
                      ([category, types]) => {
                        ...
                        return (
                          <div
                            key={category}
                            className="rounded-lg border border-white/5 bg-slate-950/30 p-4"
                          >
                ...
                <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900/90 via-slate-900/80 to-slate-950/90 backdrop-blur-xl p-6">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <button
                      ...
                      className="group flex flex-col items-start gap-2 rounded-lg border border-white/10 bg-white/5 p-4 text-left transition-all hover:border-blue-400/30 hover:bg-blue-500/10"
                    >
                      ...
                      <div>
                        <p className="font-semibold text-white">Add City</p>
                        <p className="text-xs text-slate-400">
                          Create new township
                        </p>
                      </div>
                    ...
                    <button
                      ...
                      className="group flex flex-col items-start gap-2 rounded-lg border border-white/10 bg-white/5 p-4 text-left transition-all hover:border-emerald-400/30 hover:bg-emerald-500/10"
                    >
                      ...
                      <div>
                        <p className="font-semibold text-white">Add Location</p>
                        <p className="text-xs text-slate-400">
                          Create new point
                        </p>
                      </div>
                    ...
                    <button
                      ...
                      className="group flex flex-col items-start gap-2 rounded-lg border border-white/10 bg-white/5 p-4 text-left transition-all hover:border-yellow-400/30 hover:bg-yellow-500/10"
                    >
                      <div className="rounded-lg bg-yellow-500/20 p-2 transition-colors group-hover:bg-yellow-500/30">
                        <svg
                    ...
                    <button
                      ...
                      className="group flex flex-col items-start gap-2 rounded-lg border border-white/10 bg-white/5 p-4 text-left transition-all hover:border-cyan-400/30 hover:bg-cyan-500/10"
                    >
                      <div className="rounded-lg bg-cyan-500/20 p-2 transition-colors group-hover:bg-cyan-500/30">
                        <svg
                          className="h-5 w-5 text-cyan-400"
                          fill="none"
                          stroke="currentColor"
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead className="border-b border-white/10 bg-white/[0.02]">
                        <tr>
                          <th className="px-4 py-3 text-left text-[11px] font-semibold uppercase tracking-[0.25em] text-emerald-100/70">
                            Username
                          </th>
                          <th className="px-4 py-3 text-left text-[11px] font-semibold uppercase tracking-[0.25em] text-emerald-100/70">
                            Email
                          ...
                          <th className="px-4 py-3 text-right text-[11px] font-semibold uppercase tracking-[0.25em] text-emerald-100/70">
                            Actions
                          </th>
                        </tr>
                      </thead>
                              ...
                              <td className="px-4 py-3">
                                <div className="flex items-center justify-end">
                                  <button
                                    ...
                                    className="inline-flex items-center gap-1.5 rounded-lg bg-rose-500/10 px-3 py-1.5 text-xs font-semibold text-rose-300 transition hover:bg-rose-500/20 hover:text-rose-200 border border-rose-500/30 disabled:opacity-50 disabled:cursor-not-allowed"
                                  >
                                    {revokingCollaboratorId === collab.id ? (
                                      <>
                                        <svg
                                  ...
                                  <span
                                    className={`inline-flex rounded-full px-2.5 py-0.5 text-xs font-semibold ${
                                      request.status === "pending"
                                        ? "bg-yellow-400/10 text-yellow-100 border border-yellow-400/30"
                                        : request.status === "approved"
                                        ? "bg-emerald-400/10 text-emerald-100 border border-emerald-400/30"
                                        : "bg-rose-400/10 text-rose-100 border border-rose-400/30"
                                    }`}
                                  >
                                    ...
                                    {request.status === "pending" ? (
                                      <>
                                        <button
                                          ...
                                          className="inline-flex items-center gap-1.5 rounded-lg bg-emerald-500/10 px-3 py-1.5 text-xs font-semibold text-emerald-300 transition hover:bg-emerald-500/20 hover:text-emerald-200 border border-emerald-500/30 disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                          {approvingRequestId === request.id ? (
                                            <>
                                              <svg
                                ...
                                <td className="px-4 py-3">
                                  <div className="flex items-center justify-end gap-2">
                                    ...
                                    <button
                                      ...
                                      className="inline-flex items-center gap-1.5 rounded-lg bg-rose-500/10 px-3 py-1.5 text-xs font-semibold text-rose-300 transition hover:bg-rose-500/20 hover:text-rose-200 border border-rose-500/30"
                                    >
                                      <svg
                                        className="h-3.5 w-3.5"
                                        fill="none"
                              ...
                              <td className="px-4 py-3">
                                <div className="flex items-center justify-end gap-2">
                                  ...
                                  <button
                                    ...
                                    className="rounded-md bg-rose-500/10 px-3 py-1.5 text-xs font-medium text-rose-400 transition-colors hover:bg-rose-500/20"
                                  >
                                    Reject
                                  </button>
                                </div>
